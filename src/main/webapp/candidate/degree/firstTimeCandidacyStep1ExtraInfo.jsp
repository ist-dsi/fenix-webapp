...
<div style="margin-bottom: 1rem;">
    <div style="display: flex; justify-content: center; align-items: center; font-size: 10px; background-color: #edffd0; padding: 10px 20px; border:1px solid #dddddd;">
        ...
        <label for="agreement1" style="font-size: 11px;">
            <b>Tomada de conhecimento sobre a cedência de dados para emissão do Cartão do IST.</b> No âmbito do Protocolo existente entre o Instituto Superior Técnico e o Banco Santander S.A., a emissão do cartão de identificação é feita com a cooperação da entidade bancária, com benefícios para os alunos e restantes utentes da Escola. O cartão de identificação é obrigatório e totalmente gratuito, sendo a sua utilização essencial para o bom funcionamento dos serviços da Escola. </br>Assim, declaro que tomei conhecimento que o Instituto Superior Técnico enviará ao Banco Santander S.A. os seguintes dados, para efeitos de emissão e utilização do cartão de identificação do Instituto Superior Técnico: Técnico ID, Nome a constar no cartão, categoria na escola e departamento associado ao curso.
        </label>
    </div>
</div>
...
<div style="margin-bottom: 1rem;">
    <div style="display: flex; justify-content: center; align-items: center; font-size: 10px; background-color: #edffd0; padding: 10px 20px; border:1px solid #dddddd;">
        ...
        <label for="agreement2" style="font-size: 11px;">
            <b>Tomada de conhecimento sobre a cedência de dados para emissão do Cartão da ULisboa.</b> No âmbito do Protocolo existente entre a Universidade de Lisboa e a Caixa Geral de Depósitos , a emissão do cartão de identificação é feita com a cooperação da entidade bancária, com benefícios para os alunos e restantes utentes da Escola. O cartão de identificação é obrigatório e totalmente gratuito, sendo a sua utilização essencial para a identificação do aluno noutras escolas da Universidade e acesso às unidades alimentares (cantinas) dos Serviços de Acção Social da Universidade de Lisboa. </br> Assim, declaro que tomei conhecimento que o Instituto Superior Técnico enviará à Caixa Geral de Depósitos os seguintes dados, para efeitos de emissão e utilização do cartão de identificação da Universidade de Lisboa: Técnico ID , Nome do aluno , Tipo, número e emissão/validade do documento de identificação , Nacionalidade , Data de nascimento , Identificação fiscal , Nome e Tipo do curso , Ano curricular
        </label>
    </div>
</div>
