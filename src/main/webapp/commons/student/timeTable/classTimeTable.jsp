...
<%@page import="pt.ist.fenixedu.tutorship.domain.Tutorship"%>
<%@page import="org.fenixedu.academic.domain.candidacy.StudentCandidacy"%>
...
<html:html xhtml="true">
	...
	<body>
		...
		<%
			StudentCandidacy candidacy = (StudentCandidacy) request.getAttribute("candidacy");
			if(candidacy != null) {
			...
			<div style="text-align: left">
				<p>
					<h3>					
						...
						<bean:write name="tutor" property="name"/>				
					</h3>
